...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://api.twitter.com/2/users/20536157/tweets?max_results=5&tweet.fields=id",
            False,
        ),
        (
            "https://api.twitter.com/2/tweets/1570903551312011264?tweet.fields=entities&expansions=entities.mentions.username",
            True,
        ),
    ],
)
